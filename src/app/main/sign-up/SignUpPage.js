...
function SignUpPage() {
  ...
  return (
    ...
    <div className="w-full p-24 flex-1" style={{ margin: '0 auto', backgroundImage: 'linear-gradient(to bottom right, #FDFCFB, #E2D1C3)' }}>
      <div className='p-8'>
            ...
            <Stack spacing={5} sx={{ padding: '16px' }}>
              ...
              <div>
                ...
                {formik.touched.profilePicture && formik.errors.profilePicture && (
                  <p style={{ fontSize: '12px', color: 'red', padding: '0.75rem' }}>
