...
import { PATIENTSTATUS } from '../../Static/filterLists';
import { selectPatientsSearchText, setPatientsSearchText } from '../../../store/reduxSlice/patientsSlice';
    ...
    <>
      <div className="w-full flex flex-col min-h-full">
          ...
          <div className="flex flex-col w-full sm:w-auto sm:flex-row space-y-16 sm:space-y-0 flex-1 items-center justify-end space-x-8">
            ...
            >
              ...
              {searchText && <FuseSvgIcon
                ...
                onClick={() => dispatch(setPatientsSearchText(null))
                }>
                heroicons-solid:x
              </FuseSvgIcon>
              }
        ...
        <div className='flex sm:flex-row flex-wrap flex-col justify-between mx-10  mb-10 shadow-1 rounded-16'>
          <div className="flex sm:flex-row flex-wrap flex-col justify-start">
            ...
            />
            {/* {_.size(planList) > 0 && <Autocomplete
              disablePortal
              ...
              sx={{ my: 1, minWidth: 140, mx: 1 }}
              onChange={(e, newValue) => setFilterData({ ...filterData, planName: newValue })}
              renderInput={(params) => <TextField {...params} label="Membership Plan" variant="standard" />}
            />}
      ...
      >
        ...
        <Box sx={style}>
          ...
          <PatientRegisterForm setChange={props.setChange} change={props.change} setOpen={setOpen} />
        </Box>
      </Modal>
    </>
  );
