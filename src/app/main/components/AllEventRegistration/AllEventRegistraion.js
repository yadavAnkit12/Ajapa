...
function AllEventRegistration() {
  ...
  return (
    <FusePageCarded
      header={<AllEventRegistrationHeader eventList={eventList} setChange={setChange} change={change} setFilterValue={setFilterValue} searchText={searchText} setSearchText={setSearchText} Role={getUserRoles()} eventPermission={permissions}/>}
      content={<AllEventRegistraionTable eventList={eventList} setChange={setChange} change={change} filterValue={filterValue} searchText={searchText} Role={getUserRoles()} eventPermission={permissions}/>}
