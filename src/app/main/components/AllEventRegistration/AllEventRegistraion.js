...
useEffect(()=>{
  ...
  return (
    <FusePageCarded
      header={<AllEventRegistrationHeader eventList={eventList} setChange={setChange} change={change} setFilterValue={setFilterValue} searchText={searchText} setSearchText={setSearchText}/>}
      content={<AllEventRegistraionTable eventList={eventList} setChange={setChange} change={change} filterValue={filterValue} searchText={searchText}/>}
