...
import { Avatar, Button, Card, CardActions, CardContent, CardHeader, IconButton, Input, List, ListItem, ListItemText, Paper, Typography, Box } from '@mui/material';
...
function TimelineTab() {
  ...
  useEffect(() => {
    axios.get('/api/profile/timeline').then((response) => {
