...
import ServiceTableHead from './CaseTableHead';
import ServiceView from './CaseView';
...
console.log(params)
    ...
    function getStatus(id, selectedValue) {
        ...
        // (selectedValue.toString().toLowerCase() !== 'published') ? setStatusOpen(true) : setPublishOpen(true);
        // setStatusValue({ id: id, name: name, value: selectedValue });
