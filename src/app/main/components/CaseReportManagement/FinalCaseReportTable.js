...
import FinalCaseReportTableHead from './FinalCaseReportTableHead';
...
function FinalCaseReportTable(props) {
...
console.log(props.filterValue)
    ...
    const fetchData = () => {
        ...
        const params = {
            ...
            clinic:_.get(props, 'filterValue.clinic')
        };
console.log(params)
...
export default withRouter(FinalCaseReportTable);